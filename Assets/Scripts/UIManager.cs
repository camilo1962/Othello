...
public class UIManager : MonoBehaviour
{
    ...
    public void SetPlayerTXT(Player CurrentPlayer){
        ...
        if(CurrentPlayer == Player.Black){
            ...
            toptext.text = "Turno Negras <sprite name=DiskBlackUp>";
        }

        if(CurrentPlayer == Player.White){

            toptext.text = "Turno Blancas <sprite name=DiskWhiteUp>";
        }
    ...
    public void SetSkippedTXT(Player SkippedPlayer){
        ...
        if(SkippedPlayer == Player.Black){
            ...
            toptext.text = "Negras no pueden moverse <sprite name=DiskBlackUp>";
        }

        if(SkippedPlayer == Player.White){

            toptext.text = "Blancas no pueden moverse <sprite name=DiskWhiteUp>";
        }
    ...
    public void SetWinnerText(Player winner){
        ...
        switch(winner){
            ...
            case Player.Black:
                WinnerTXT.text = "NEGRAS GANAN";
                break;
            case Player.White:
                WinnerTXT.text = "BLANCAS GANAN";
                break;
            case Player.None:
